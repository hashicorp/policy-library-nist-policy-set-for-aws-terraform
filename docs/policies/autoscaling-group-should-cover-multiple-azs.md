...
This rule is covered by the [autoscaling-group-should-cover-multiple-azs](https://github.com/hashicorp/policy-library-NIST-Policy-Set-for-AWS-Terraform/blob/main/policies/autoscaling-group/autoscaling-group-should-cover-multiple-azs.sentinel) policy.
