...
This rule is covered by the [network-firewall-logging-enabled](https://github.com/hashicorp/policy-library-NIST-Policy-Set-for-AWS-Terraform/blob/main/policies/networkfirewall/network-firewall-logging-enabled.sentinel) policy.
