...
This rule is covered by the [neptune-cluster-db-auth-enabled](https://github.com/hashicorp/policy-library-NIST-Policy-Set-for-AWS-Terraform/blob/main/policies/neptune/neptune-cluster-db-auth-enabled.sentinel) policy.
